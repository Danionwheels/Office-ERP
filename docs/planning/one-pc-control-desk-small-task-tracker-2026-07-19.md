...
| `SVC05-07` | `CURRENT` | Add the readiness-aware launcher with operator-friendly recovery guidance. | `SVC05-06B` | It opens only `127.0.0.1:5188` after readiness without requiring a terminal. |
