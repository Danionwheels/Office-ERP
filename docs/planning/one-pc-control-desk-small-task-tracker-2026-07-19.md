...
| `SEC04-07B` | `CURRENT` | Implement offline operator recovery, machine-secret replacement/reissue, and session invalidation. | `SEC04-07A`, `SEC04-04` | Recovery requires actor/reason, invalidates old sessions, and proves preserve-versus-reissue rules. |
