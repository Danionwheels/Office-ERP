...
| `SEC04-02B3` | `CURRENT` | Add disable and permission-change application use cases with last-active-administrator protection. | `SEC04-02B2` | Focused tests prove authorization, missing-target handling, session-version changes, and last-admin refusal. |
