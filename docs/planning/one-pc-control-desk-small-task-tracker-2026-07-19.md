...
| `SEC04-06A` | `CURRENT` | Implement versioned DPAPI envelopes with atomic replacement, lifecycle mutex, tamper detection, and non-secret fingerprints. | `SEC04-01` | Hermetic success, interruption, concurrent-write, and tamper tests pass. |
