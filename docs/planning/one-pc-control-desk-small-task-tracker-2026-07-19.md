...
| `SEC04-02B` | `CURRENT` | Add operator create, authenticate, disable, permission-change, and recovery application ports/use cases. | `SEC04-02A` | Focused use-case tests cover success, conflicts, disabled operators, and authorization. |
