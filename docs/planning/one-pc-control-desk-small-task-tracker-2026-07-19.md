...
| `SEC04-07A` | `CURRENT` | Implement elevated, no-echo first-operator provisioning. | `SEC04-02C`, `SEC04-03`, `SEC04-06B` | Bootstrap is single-use, refuses overwrite, and emits only secret-free evidence. |
