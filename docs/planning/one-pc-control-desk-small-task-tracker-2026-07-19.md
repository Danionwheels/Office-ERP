...
| `SEC04-06B` | `CURRENT` | Converge machine-secret directory/file ACLs and expose secrets only through the installed configuration provider. | `SEC04-06A` | Exact ACL audit and normal-Windows-account denial proof pass. |
