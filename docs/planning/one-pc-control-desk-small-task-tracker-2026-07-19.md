...
| `SVC05-06A` | `CURRENT` | Activate the API service only after database, migrations, first operator, and `/ready` succeed. | `SVC05-05B`, `SEC04-07A` | Failed prerequisite/readiness leaves the service stopped with an actionable reason. |
