...
| `SEC04-03` | `CURRENT` | Extract the PBKDF2-SHA256 codec from the HTTP endpoint without changing the accepted format. | `SEC04-01` | Golden, tamper, and invalid-format vectors pass. |
