...
| `SVC05-06B` | `CURRENT` | Add narrowly classified API-service repair operations and ownership checks. | `SVC05-06A` | Repair mutation/no-mutation matrix passes without overwriting foreign state. |
