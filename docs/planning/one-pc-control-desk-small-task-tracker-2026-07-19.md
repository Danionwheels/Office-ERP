...
| `SVC05-10A` | `CURRENT` | Compose one elevated setup entry for preflight, VC++, PostgreSQL, and migrations. | `SVC05-01`, `DB03-04`, `SVC05-02` | One invocation and idempotent rerun pass through the database-ready checkpoint. |
