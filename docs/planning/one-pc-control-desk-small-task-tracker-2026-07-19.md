...
| `SVC05-10B` | `CURRENT` | Extend the same setup entry through machine secrets and no-echo first-operator provisioning. | `SEC04-07A`, `SVC05-10A` | One invocation reaches protected operator-ready state; rerun refuses destructive overwrite. |
