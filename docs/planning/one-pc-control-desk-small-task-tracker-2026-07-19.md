...
| `SEC04-04` | `CURRENT` | Make login/session authorization read active persisted operators instead of packaged `IOptions` users. | `SEC04-02C3`, `SEC04-03` | Existing auth tests plus permission/status-change invalidation pass. |
