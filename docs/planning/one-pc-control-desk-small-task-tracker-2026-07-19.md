...
| `SVC05-08` | `CURRENT` | Add owned Start-menu entry and optional desktop shortcut with idempotent repair. | `SVC05-07` | Exact shortcut target/arguments and repair pass. |
