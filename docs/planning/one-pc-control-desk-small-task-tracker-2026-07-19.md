...
| `SEC04-02B4` | `CURRENT` | Add the offline password-recovery application use case with required actor and reason. | `SEC04-02B3` | Focused tests prove missing/ambiguous target refusal, password replacement, session invalidation, and secret-free results. |
