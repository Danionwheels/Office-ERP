...
| `SEC04-08` | `CURRENT` | Inventory every installed API route and bind each protected route to an explicit role/scope policy. | `SEC04-04` | Automated inventory fails on anonymous or mismatched route policy; intended public health/login routes are allowlisted. |
