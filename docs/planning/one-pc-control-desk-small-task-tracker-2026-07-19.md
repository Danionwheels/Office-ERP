...
| `SVC05-05B` | `CURRENT` | Configure the PostgreSQL service dependency, delayed automatic start, and bounded recovery actions. | `SVC05-05A` | Exact SCM dependency/start/recovery settings pass. |
