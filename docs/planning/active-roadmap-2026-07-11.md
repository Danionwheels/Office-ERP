...
- [ ] `OFFICE-P0-01`: produce one loopback, same-origin, self-contained Windows artifact. Local package proof is green; clean GitHub Windows gate remains before completion.
