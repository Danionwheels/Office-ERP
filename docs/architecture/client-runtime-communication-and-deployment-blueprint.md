...
- Production hardening for the app revocation hook and broader control lane: real provider-user login/MFA and manager UX for issuing scoped provider sessions, production secret custody/rotation, and customer-facing clean setup UX.
