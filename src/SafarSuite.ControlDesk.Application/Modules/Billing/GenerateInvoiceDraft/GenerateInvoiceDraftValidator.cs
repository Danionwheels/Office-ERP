...
public sealed class GenerateInvoiceDraftValidator : IValidator<GenerateInvoiceDraftCommand>
{
    public IReadOnlyCollection<ApplicationError> Validate(GenerateInvoiceDraftCommand value)
    {
